...
class Shopkeeper(init_pos: (Int, Int), b: GameBoard) extends Character(init_pos, b) with FleeingWhenDamaged with Serializable {
  val name = "Vending machine"
  val description = "It sells low quality goods at a high price"
  image = "src/main/resources/entity_sprites/vendingmachine.png"
